    ...
    return (
      <div className="UserProfile">
        <div className="User">
          ...
          <div className="image">
            <img src="https://ih0.redbubble.net/image.618379802.1473/flat,1000x1000,075,f.u2.jpg" />
          </div>
        </div>
      </div>
    );
  ...
  render: function () {
    return (
      <div
        ...
        style={{
          backgroundImage:
            "url(https://wallpapershdnow.com/images/tv-shows/crime-drama/money-heist-netflix/money-heist-netflix-background-13.jpg)",
        }}
      >
...
var ListToggle = React.createClass({
  ...
  render: function () {
    return (
      <div onClick={this.handleClick} data-toggled={this.state.toggled}></div>
    );
  },
});
