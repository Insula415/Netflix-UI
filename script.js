	...
	render: function() {
		...
		return (
			<div>
				...
				<Hero />
				<TitleList title="Popular on Netflix" url='discover/tv?sort_by=popularity.desc&page=1' />
				<TitleList title="Trending now" url='discover/movie?sort_by=popularity.desc&page=1' />
				<TitleList title="Horror" url='genre/27/movies?sort_by=popularity.desc&page=1' />
				<TitleList title="Sci-Fi" url='genre/878/movies?sort_by=popularity.desc&page=1' />
				<TitleList title="Comedies" url='genre/35/movies?sort_by=popularity.desc&page=1' />
			</div>
		);
	}
});
	...
	render: function() {
		return (
			<div className="UserProfile">
				<div className="User">
					<div className="name">Insula</div>
					<div className="image"><img src="https://ih0.redbubble.net/image.618379802.1473/flat,1000x1000,075,f.u2.jpg" /></div>
				</div>
			</div>
		);
	}
...
var Hero = React.createClass({
	render: function() {
		return (
			<div id="hero" className="Hero" style={{backgroundImage: 'url(https://wallpapershdnow.com/images/tv-shows/crime-drama/money-heist-netflix/money-heist-netflix-background-13.jpg)'}}>
...
var ListToggle = React.createClass({
	...
	render: function() {
		return (
			<div onClick={this.handleClick} data-toggled={this.state.toggled}>
			</div>
		);
	}
});
